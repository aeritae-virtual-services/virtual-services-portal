...
<body>
		...
		<div class="body">
			<div class="panel panel-default">
				...
				<div class="panel-form">
					...
					<form action="<%=formAction%>" method="POST" id="request_form">
						<input type="hidden" name="id" value='${operation eq "update" ? request.id : ""}' />
	...
	<%@ include file="/WEB-INF/partials/watch_list_modal.jsp"%>
