<nav class="navbar navbar-default navbar-default navbar-fixed-top">
	<div class="container-fluid">
		<div class="navbar-header">
			<a class="navbar-text navbar-left auth-req" href="" data-toggle="tooltip" title="Toggle Navigation" data-placement="bottom" onclick="$('#wrapper').toggleClass('toggled'); return false;">
